...
class DzikirPetangCard extends StatefulWidget {
  final DzikirPetang dzikir;

  const DzikirPetangCard({super.key, required this.dzikir});

  @override
  _DzikirPetangCardState createState() => _DzikirPetangCardState();
}

class _DzikirPetangCardState extends State<DzikirPetangCard> {
